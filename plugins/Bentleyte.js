...
async (conn, mek, m, { from }) => {
    try {
        ...
        const repoURL = "https://api.github.com/repos/betingrich3/Bentley/commits";
        ...
        const commitDetailsURL = `https://api.github.com/repos/betingrich3/Bentley/commits/${latestCommitSHA}`;
        ...
        if (latestCommitSHA !== currentCommitSHA) {
            await conn.sendMessage(from, { text: " Wait for update started......" }, { quoted: mek });
            ...
            await conn.sendMessage(from, { text: "*You are using the latest version of Bentley*" }, { quoted: mek });
        }
    } catch (error) {
...
async function downloadAndUpdateFile(commitSHA, fileName, savePath) {
    try {
        const fileURL = `https://raw.githubusercontent.com/betingrich3/Bentley/${commitSHA}/${fileName}`;
